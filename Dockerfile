...
CMD python3 -m gunicorn main:app --workers ${WEB_CONCURRENCY:-3} --worker-class uvicorn.workers.UvicornWorker --bind 0.0.0.0:10000 --timeout 300 --graceful-timeout 120 --log-level info